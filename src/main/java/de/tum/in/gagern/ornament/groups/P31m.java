/* $Id: P31m.java,v 1.5 2003/02/16 23:43:15 gagern Exp $
...
/**
 * The crystallographic group p31m.
 *
 * @author Martin von Gagern
 * @version $Revision: 1.5 $
 */
public class P31m extends Group implements Constants {

    static final String[] NAMES={"p31m", "3*3"};
	...
	new Property.Turn3(2/3., 2/3., 2),
	new Property.Mirror(0, 0, 1, 0),
	new Property.Mirror(0, 0, 0, 1),
	new Property.Mirror(0, 1, 1, 0),
	new Property.Glide(0, .5, .5, 0),
	new Property.Glide(0, .5, 1, .5),
	new Property.Glide(1, .5, .5, 1),
	new Property.Glide(.5, 0, .5, 1)
    };
