/* $Id: P6.java,v 1.5 2003/02/17 13:27:12 gagern Exp $
...
/**
 * The crystallographic group p6.
 *
 * @author Martin von Gagern
 * @version $Revision: 1.5 $
 */
public class P6 extends Group implements Constants {

    static final String[] NAMES={"p6", "632"};
