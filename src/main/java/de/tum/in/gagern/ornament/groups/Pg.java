/* $Id: Pg.java,v 1.4 2003/02/17 23:01:23 gagern Exp $
...
/**
 * The crystallographic group pg.
 *
 * @author Martin von Gagern
 * @version $Revision: 1.4 $
 */
public class Pg extends Group implements Constants {

    static final String[] NAMES={"pg", "xx"};

    static final double[][] TRANSFORMS={
	{1, 0, 0, 1, 0, 0}, {1, 0, 0, -1, .5, 1}
    };

    static final Property[] PROPERTIES={
	new Property.Glide(0, 0, 1, 0, 1),
	new Property.Glide(0, .5, 1, .5, 2)
    };
	...
	new Line2D.Double(0., .25, 1., .25),
	new Line2D.Double(0., .75, 1., .75),
    };
